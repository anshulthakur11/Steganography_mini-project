...
def showimage():
    ...
    filename=filedialog.askopenfilename(initialdir=os.getcwd(),
                                        ...
                                        filetype=(("JPG File","*.jpg"),("All file","*txt")))
...
def save():
    global filename
    hidden_filename = os.path.splitext(os.path.basename(filename))[0] + "_hidden.png"
    lsb.hide(filename, text1.get(1.0, END)).save(hidden_filename)
...
Label(frame4, text="Picture, Image, Photo File" ,bg="#2f4155",fg="yellow").place (x = 28, y = 5)
